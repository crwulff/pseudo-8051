...
_RELOAD_ORDER = [
    ...
    "pseudo8051.passes._switch_detect",
    "pseudo8051.passes._switch_build",
    "pseudo8051.passes.switch",
    "pseudo8051.passes._ifelse_helpers",
    "pseudo8051.passes.ifelse",
    "pseudo8051.passes.cjne_switch",
    "pseudo8051.passes.patterns.base",
    "pseudo8051.passes.patterns._types",
    "pseudo8051.passes.patterns._expr_utils",
    "pseudo8051.passes.patterns._node_utils",
    ...
    "pseudo8051.passes.patterns.zero_ext_group",
    ...
    "pseudo8051.passes.patterns.mul16",
    ...
    "pseudo8051.passes.typesimplify._propagate_utils",
    "pseudo8051.passes.typesimplify._propagate_regcopy",
    "pseudo8051.passes.typesimplify._propagate_inline",
